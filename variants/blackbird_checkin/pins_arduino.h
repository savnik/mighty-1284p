...
// Maniacbug's Mighty-1284 core, modified for Blackbird Checkin
...
static const uint8_t LED = 19; // Blue
...
static const uint8_t LED_ONBOARD = LED; // double trouble
static const uint8_t LED_RED = 18;
static const uint8_t LED_GREEN = 20;
